...
for tg in range(N_targets):
    ...
    f = open("bo_075_"+TG+"_"+"DupliCheck.txt","a")
    print(TG,file=f)
    print('=========================================================',file=f)
    ...
    print('=========================================================',file=f)
    print('================B3b ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*2900)]
    ...
    print('=========================================================',file=f)
    print('================B4a ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*4600)]
    ...
    print('=========================================================',file=f)
    print('================B4b ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*6900)]
    ...
    print('=========================================================',file=f)
    print('================B5a ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*8000)]
    ...
    print('=========================================================',file=f)
    print('================B5b ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*5000)]
    ...
    print('=========================================================',file=f)
    print('================B5c ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*1.1e4)]
    ...
    print('=========================================================',file=f)
    print('================B5d ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*6500)]
    MOL = ["CCH", "SiO", "HNCO"]
    ...
    print('=========================================================',file=f)
    print('================B6a ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*6000)]
    ...
    print('=========================================================',file=f)
    print('================B6b ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*1.0e4)]
    ...
    print('=========================================================',file=f)
    print('================B6c ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*1.2e4)]
    MOL = ["CH3CN", "SO", "HNC"]      
    ...
    print('=========================================================',file=f)
    print('================B7a ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*5900)]
    ...
    print('=========================================================',file=f)
    print('================B7b ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*9000)]
    MOL = ["CS", "SO", "HCN", "HCOp"]   
    ...
    print('=========================================================',file=f)
    print('================B7c ====================',file=f)
    selected = myquery[(myquery['ang_res_arcsec'] < Beam_max) & (myquery['vel_res_kms'] < 20.0) & (myquery['line_sens_10kms']<2.0*4700)]
